...
object test {
    ...
    def testData() = {
        ...
        val rand = new Random()
        val l = new ListBuffer[Tuple2[Double, Array[String]]]()
        for (i <- 0 until 1000) {
            var label = -1.0
        ...
        sc.parallelize(l.toList).map(row => (row._1, row._2)).toDF("label", "features")
    }
}

//import sqlContext.implicits._
//val rand = new Random()
//val l = new ListBuffer[Tuple2[Double, Array[Tuple2[Int, Int]]]]()
//for (i <- 0 until 1000) {
//var label = -1.0
//if (abs(rand.nextInt()) % 2 == 1)
//label = 1.0
...
//l += Tuple2(label,
//Array(
//Tuple2(abs(rand.nextInt() % 5), abs(rand.nextInt() % 10)),
//Tuple2(abs(rand.nextInt() % 5), abs(rand.nextInt() % 10)),
//Tuple2(abs(rand.nextInt() % 5), abs(rand.nextInt() % 10)),
//Tuple2(abs(rand.nextInt() % 5), abs(rand.nextInt() % 10)),
//Tuple2(abs(rand.nextInt() % 5), abs(rand.nextInt() % 10)))
...
//l += Tuple2(label,
//Array(
//Tuple2(abs(rand.nextInt() % 5 + 5), abs(rand.nextInt() % 10)),
//Tuple2(abs(rand.nextInt() % 5 + 5), abs(rand.nextInt() % 10)),
//Tuple2(abs(rand.nextInt() % 5 + 5), abs(rand.nextInt() % 10)),
//Tuple2(abs(rand.nextInt() % 5 + 5), abs(rand.nextInt() % 10)),
//Tuple2(abs(rand.nextInt() % 5 + 5), abs(rand.nextInt() % 10)))
